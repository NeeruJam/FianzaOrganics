...
const categories =['Hair Care','Skin Care', 'Face Care','Lip Care', 'Kids Care', 'Gift Hampers' ];
...
<Pagination count={Math.trunc(productCount/resultPerPage)} page={currentPage} onChange={setCurrentPageNo} />
            </div>
          )}
           </div>
        </>
